...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "top_left_drive");
        leftRear = hardwareMap.get(DcMotorEx.class, "bottom_left_drive");
        rightRear = hardwareMap.get(DcMotorEx.class, "bottom_right_drive");
        rightFront = hardwareMap.get(DcMotorEx.class, "top_right_drive");
